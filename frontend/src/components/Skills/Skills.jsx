...
import {
  LayoutDashboard, Server, Database, BarChart3, Wrench,
  Cloud, Palette, Layers, ChevronDown, ChevronUp,
} from 'lucide-react';
...
const skillGroups = [
  ...
  { Icon: BarChart3,       title: 'Data Science', tags: ['Python','NumPy', 'Pandas', 'Matplotlib', 'Excel','Statistics'] },
  ...
  { Icon: Layers,          title: 'UI/UX Design',  tags: ['Figma', 'Wireframing', 'Adobe XD','Prototyping'] },
];
          ...
          <div style={{ textAlign: 'center', marginTop: '48px' }}>
            ...
            >
              {showAll ? (
                ...
                <><ChevronDown size={16} /> View More ({skillGroups.length - INITIAL_COUNT} more)</>
              )}
            </button>
          </div>
        )}
